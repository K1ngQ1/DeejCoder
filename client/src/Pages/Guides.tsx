...
//guides coming about how to complete your arduino build and flash the firmware
export default function () {
    return (
        <>
            <div className="artboard bg-base-200 rounded-xl border border-solid border-accent p-2 w-10/12 m-2">
                <a className="btn btn-accent" href="#site">
                    How to use our site
                </a>
